...
ICOMMAND(execl, "s", (char *file), execlua(file)); // CMEd Legacy;
...
int lua_entinfo(lua_State *L)
{
    int argc = lua_gettop(L);
    if(argc < 1) return 0;

    int id = lua_tonumber(L, 1);
    if(id < 0 || id >= MAXENTS) return 0;
    ...
    for(i = 2; i <= argc; i++)
    {
        ...
        switch (type)
        {
            case 1: ret = e->o.x; break;
            case 2: ret = e->o.y; break;
            case 3: ret = e->o.z; break;
            case 4: ret = e->attr1; break;
            case 5: ret = e->attr2; break;
            case 6: ret = e->attr3; break;
            case 7: ret = e->attr4; break;
            case 8: ret = e->attr5; break;
            case 9: ret = e->type; break;
        }
...
int init_lua()
{
    ...
    lua_register(L, "sauer_entinfo",        lua_entinfo);
