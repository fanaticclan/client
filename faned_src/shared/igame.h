...
namespace game
{
    ...
    extern const char *faned_autoexec();
    extern const char *faned_config();
    extern const char *faned_defaultconfig();
    extern const char *faned_restoreconfig();
    extern const char *faned_scripts();
    extern const char *faned_savedservers();
    extern const char *faned_sounds();
    extern const char *faned_whois();
    // End: Fanatic Edition
...
namespace server
{
    ...
    extern void sendservmsgf(const char *fmt, ...); // Fanatic Edition
