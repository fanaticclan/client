...
#define GUI_TITLE_COLOR  0x50CFE5 // Fanatic Edition
#define GUI_BUTTON_COLOR 0xFFFFFF // Fanatic Edition
#define GUI_TEXT_COLOR   0xFFFFFF // Fanatic Edition
...
void showgui(const char *name)
{
    ...
    playsound(S_GUIOPEN); // Fanatic Edition
}
...
int cleargui(int n)
{
    ...
    if(!guistack.empty())
    {
        ...
        playsound(S_GUICLOSE); // Fanatic Edition
    }
    return clear;
}
